            ...
            <div class="survey-card">
                ...
                <div class="first-line">
                    ...
                    <div class="description">
                        <div class="name-wrap">
                            <a href="<?= Url::toRoute(['default/view/', 'id' => $survey->survey_id]) ?>" class="name" data-pjax="0" title="<?= Html::encode($survey->survey_name) ?>"><?= Html::encode($survey->survey_name) ?></a>
                        </div>
                        <div>
                            <div class="survey-labels">
                                ...
                                <span class="survey-label completed-respondents" data-toggle="tooltip" title="<?= \Yii::t('survey', 'Were interviewed') ?>"><?= $survey->getCompletedRespondentsCount() ?></span>
                                <span class="survey-label" data-toggle="tooltip" title="<?= \Yii::t('survey', 'Questions count') ?>"><?= $survey->getQuestions()->count() ?></span>
                            </div>
                            <div class="survey-actions">
                                <a href="<?= Url::toRoute(['default/update/', 'id' => $survey->survey_id]) ?>" class="btn btn-info btn-xs" data-pjax="0" title="edit"><span class="glyphicon glyphicon-pencil"></span></a>
                                <?php
